 ...
 */
//资质打包记录
Vue.component("hospital-qua-list-component", {
  template: "#hospital-qua-list-template",
  props: {},
  data() {
    return {
      dialogTitle: "",
  ...
  methods: {
    ...
    fetchData() {
      ...
      this.$http
        .post(getCtx() + "/hospital/qua/hospitalquainfo", params, {
    ...
    handleSearchHospitalDetailQua: function(row) {
      location.href =
        getCtx() +
        "/hospital/qua/hospitalquadetail?quaType=" +
        row.quaType +
        "&quaName=" +
        row.quaName;
    },
